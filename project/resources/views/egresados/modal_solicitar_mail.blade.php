{{-- MODAL PARA SOLICITAR MAIL CON TODA LA INFO DE EGRESADO --}}
    ...
    <div class="modal-dialog">
        <div class="modal-content estilo-modal-container">
            ...
            <div class="modal-body formulario">
                <p>Por cuestiones de privacidad los datos de contacto de este egresado se los enviaremos por mail.</p>
                <p>Por favor, complete los siguientes campos para poder recibir la información solicitada.</p>
                <form action="{{ route('egresado_solicitar',['id' => $egresado_id]) }}" role="form"
                ...
                <div class="modal-footer">
                    <button id="solicitar-datos-egresado" type="button" class="btn btn-primary">Enviar
                    </button>
